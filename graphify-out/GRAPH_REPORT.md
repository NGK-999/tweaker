# Graph Report - Apextweaker  (2026-07-28)

## Corpus Check
- 181 files · ~141,695 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2986 nodes · 6197 edges · 183 communities (163 shown, 20 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 364 edges (avg confidence: 0.74)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1414982b`
...
9. `ApexTweaker.Models` - 41 edges
10. `ApexTweaker.Services` - 38 edges
...
- `UserControl` --references--> `FeedbackTitle`  [INFERRED]
  src/UI/Wpf/Views/CatalogView.xaml → src/UI/Wpf/ViewModels/CatalogViewModel.cs
- `UserControl` --references--> `StatusMessage`  [INFERRED]
...
## Communities (183 total, 20 thin omitted)

### Community 1 - "TweakService"
Cohesion: 0.24
Nodes (7): Border, RiskBadge, RiskLevel, DependencyObject, DependencyProperty, DependencyPropertyChangedEventArgs, TextBlock

### Community 2 - "ApexTweaker.Models"
Cohesion: 0.13
Nodes (12): ApexTweaker.Services, ApexTweaker, ApexTweaker.Application.Optimizations, ApexTweaker.Infrastructure, ApexTweaker.Models, ApexTweaker.Core.Pipeline, AuditRow, UninstallTarget (+4 more)

### Community 3 - "CpuTopologyNative"
Cohesion: 0.16
Nodes (9): ProfileOperation, MinecraftBackupFileEntry, MinecraftRollbackResult, MinecraftProfileService, IReadOnlyCollection, IReadOnlyList, JsonSerializerOptions, List (+1 more)

### Community 4 - "WindowsOptimizationModels.cs"
Cohesion: 0.23
Nodes (8): WindowsOptimizationSelfTest, IReadOnlyList, WindowsDeviceKind, WindowsOptimizationContext, WindowsOptimizationPlan, WindowsOptimizationPreset, WindowsUsageProfile, IReadOnlyList
...
Cohesion: 0.10
Nodes (14): ComputerInventory, DeviceGuardInventory, OperatingSystemInventory, ProcessorInventory, FeatureState, WindowsPowerSource, WindowsOptimizationInventoryService, DllImport (+6 more)
...
### Community 11 - ".Run"
Cohesion: 0.10
Nodes (10): ApplicationPaths, IReadOnlyList, GamingFpsProbeSelfTest, MarketCoverageSelfTest, Program, MinecraftCommandLine, MarketUtilitiesService, IEnumerable (+2 more)
...
Cohesion: 0.19
Nodes (8): ApexTweaker.UI.Wpf.Controls, ApexTweaker.UI.Wpf.Theming, ApexTweaker.UI.Wpf.Views, ApexTweaker.UI.Wpf.ViewModels, ApexTweaker.UI.Wpf.Testing, CommandPaletteItem, CatalogFeedbackSelfTest, EasyPrimaryAction

### Community 32 - "MarketUtilitiesService"
Cohesion: 0.20
Nodes (10): MinecraftBackupManifest, MinecraftQuarantineFileEntry, MinecraftQuarantineManifest, DateTimeOffset, List, MinecraftQuarantineService, IEnumerable, IReadOnlyList (+2 more)
...
Cohesion: 0.10
Nodes (12): CancelEventArgs, Kind, Message, MainWindow, BackupService, bool, CancellationTokenSource, Dictionary (+4 more)
...
Cohesion: 0.04
Nodes (62): BackCommand, BenchmarkPoints, Color, ComparisonSummary, CurrentStep.Description, CurrentStep.Detail, CurrentStep.StateColor, CurrentStep.StateLabel (+54 more)
...
Cohesion: 0.12
Nodes (18): BeginMutationSession(), BuildUniqueMutationLedgerPath(), CaptureActivePowerScheme(), CaptureCommandState(), CapturePowerSettingValue(), CaptureProcessState(), CaptureRegistryValue(), CaptureServiceState() (+10 more)

### Community 44 - "MinecraftScientificExperimentService"
Cohesion: 0.18
Nodes (8): MinecraftScientificExperiment, MinecraftScientificOperationResult, ScientificHypothesis, MinecraftScientificExperimentService, DateTimeOffset, HashSet, IReadOnlyDictionary, IReadOnlyList
...
Cohesion: 0.09
Nodes (6): CustomExperimentCheckBox, PathTextBox, MinecraftView, bool, int, TextChangedEventArgs

### Community 47 - "LightweightBenchmarkChart"
Cohesion: 0.11
Nodes (9): KeyEventArgs, MouseButtonEventArgs, CommandPaletteInput, CommandPaletteList, CommandPaletteOverlay, TextChangedEventArgs, Border, ListBox (+1 more)
...
Cohesion: 0.15
Nodes (12): MinecraftLoader, MinecraftModDescriptor, Dictionary, HashSet, MinecraftAuditService, HashSet, IEnumerable, IReadOnlyCollection (+4 more)
...
### Community 64 - ".Run"
Cohesion: 0.15
Nodes (10): CommandRunner, CancellationToken, int, Process, Task, TimeSpan, CommandResult, CaptureBcdValue() (+2 more)
...
Cohesion: 0.09
Nodes (21): AuditSeverity, BenchmarkStatus, DiskInfo, JavaMemoryTier, MinecraftAuditIssue, MinecraftAuditSummary, MinecraftEasyInstanceStatus, MinecraftHomologationCriterion (+13 more)

### Community 79 - "MinecraftInstanceDescriptor"
Cohesion: 0.12
Nodes (7): SendMessageTimeoutFlags, TweakService, BackupService, DllImport, IntPtr, string, SystemPowerStatus
...
Cohesion: 0.22
Nodes (16): IGrouping, RegistryBackupEntry, CaptureBcdEntries(), CaptureDisplayDriverEntries(), CaptureRegistryEntries(), CreateBackup(), CreateDiagnosticReport(), CreateEmergencyRestoreScript() (+8 more)
...
Cohesion: 0.23
Nodes (3): DemoSafetySelfTest, OperationOutcome, ISystemMutationCommand

### Community 93 - "OptimizationEngine"
Cohesion: 0.15
Nodes (9): OptimizationFreshness, CpuArchitectureProfile, OptimizationEngine, OptimizationFreshness, ProcessorBoostDecision, Action, double, int (+1 more)
...
Cohesion: 0.21
Nodes (6): MinecraftExperimentDefinition, MinecraftExperimentVariable, MinecraftProfilePlan, MinecraftExtremeExperimentCatalog, int, IReadOnlyList
...
Cohesion: 0.39
Nodes (6): BottleneckCandidate, MinecraftBottleneckKind, ScientificDerivedMetrics, MinecraftBottleneckDiagnosticService, ICollection, IReadOnlyList
...
Cohesion: 0.38
Nodes (6): WindowsOptimizationRecommendationService, OptimizationDecisionKind, UsageAnswer, WindowsOptimizationDecision, WindowsOptimizationRule, CatalogRowViewModel
...
Cohesion: 0.21
Nodes (6): MinecraftAuditResult, MinecraftOperationalChecklist, MinecraftQuarantinePlan, MinecraftReportPaths, MinecraftSurvivalPlan, MinecraftSurvivalPlanService

### Community 118 - "ModulesView"
Cohesion: 0.22
Nodes (4): MinecraftProfileDefinition, MinecraftProfileKind, GeneratedRegex, Regex
...
### Community 125 - ".RunBcdEditSetting"
Cohesion: 0.42
...
Cohesion: 0.29
Nodes (3): SystemMutationCommand, Action, BackupService
...
### Community 145 - ".Run"
Cohesion: 0.25
Nodes (5): MinecraftScientificExperimentStore, IReadOnlyList, JsonSerializerOptions, object, string

### Community 146 - "P0.2-BLOCKERS — routing"
Cohesion: 0.50
Nodes (3): Gate antes de pedir re-revisão, Ownership, P0.2-BLOCKERS — routing

### Community 149 - "MinecraftInstanceService"
Cohesion: 0.21
...
### Community 151 - "GroupRegistryEntries"
Cohesion: 0.23
Nodes (5): MinecraftLauncherKind, MinecraftInstanceService, IDictionary, IReadOnlyList, string

### Community 158 - "BackupService"
Cohesion: 0.40
Nodes (4): Func, IReadOnlyList, List, Task

### Community 159 - "CancellationTokenSource"
Cohesion: 0.40
Nodes (5): BenchmarkEvidence, IoCounters, MemoryStatusEx, uint, ulong

### Community 160 - "DevMode"
Cohesion: 0.33
...
### Community 165 - "RegistryKey"
Cohesion: 0.40
Nodes (4): IoCounters, DllImport, MarshalAs, MemoryStatusEx

### Community 167 - "AppInfo.cs"
Cohesion: 0.33
Nodes (3): ApexTweaker.Minecraft, ApexTweaker.UI.Wpf.Windows, ApexTweaker.UI.Wpf
...
## Knowledge Gaps
- **505 isolated node(s):** `net10.0-windows`, `CommunityToolkit.Mvvm (8.4.2)`, `LibreHardwareMonitorLib (0.9.6)`, `Microsoft.Diagnostics.Tracing.TraceEvent (3.1.21)`, `System.Management (10.0.2)` (+500 more)
...
- **Why does `MainWindow` connect `MainWindow.xaml.cs` to `.ExecuteAsync`, `MainWindow`, `CpuTopologyNative`, `Program`, `Window`, `PowerReadACValueIndex`, `.Run`, `Master plan — sprint FE-ALL + FPS-BE`, `UtilitiesView`, `TelemetryPipeClient.cs`, `GroupRegistryEntries`, `Market coverage matrix — ApexTweaker vs EXM / BoosterX`, `MarketUtilitiesService`, `TweakService.cs`, `TelemetryView`, `MinecraftAuditResult`, `MinecraftScientificExperimentService`, `CobblemonEasyViewModel`, `MinecraftView`, `LightweightBenchmarkChart`, `MinecraftProfileService`, `TweakService`, `MinecraftBenchmarkService`, `SystemDiagnosticsService`, `MinecraftEnvironmentService`, `EtwFrameTracker`, `UserControl`, `MinecraftInstanceDescriptor`, `MinecraftCommandLine`, `CpuTopologyProfile`, `MinecraftProfilePlan`, `OptimizationEngine`, `MinecraftEasyModeService`, `TextBox`, `.TryResolve`, `.Capture`, `.RunTweakAsync`?**
  _High betweenness centrality (0.363) - this node is a cross-community bridge._
- **Why does `MinecraftView` connect `MinecraftView` to `Program`, `UtilitiesView`, `Market coverage matrix — ApexTweaker vs EXM / BoosterX`, `int`, `MainWindow.xaml.cs`, `TweakService.cs`, `UserControl`, `.TryReadOperationalObservation`, `.BuildRecommendations`, `CobblemonEasyViewModel`, `RoutedEventArgs`, `MinecraftScientificModels.cs`, `MinecraftWizardViewModel`, `.QuarantineList_OnSelectionChanged`, `.SetCurrentStep`, `MinecraftAuditModels.cs`, `MinecraftEasyModeService`, `CreateEmergencyRestoreScript`, `.RunTweakAsync`?**
  _High betweenness centrality (0.095) - this node is a cross-community bridge._
- **Why does `ApexTweaker.Services` connect `ApexTweaker.Models` to `.ExecuteAsync`, `QuarantineList`, `ValorantProcessOptimizer.cs`, `TelemetryPipeClient.cs`, `Market coverage matrix — ApexTweaker vs EXM / BoosterX`, `WindowsOptimizationInventoryService.cs`, `TweakService.cs`, `SystemRestoreService`, `AppInfo.cs`, `TelemetryView`, `ValorantProcessOptimizer.cs`, `BackupService.cs`, `HardwareTelemetryService.cs`, `TelemetryPipeServer`, `EtwFrameTracker`, `WindowsPowerModeService`, `MinecraftProfilePlan`, `OptimizationEngine`, `.EnsureAdministratorForWindowsOperation`?**
