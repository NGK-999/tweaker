...
Versao do fluxo: **ApexTweaker 3.1.0**
...
```powershell
Get-FileHash "$env:USERPROFILE\Downloads\ApexTweaker-Portable-v3.1.0.zip" -Algorithm SHA256
```

4. Compare o hash inteiro com o digest exibido na release autenticada.
5. Crie `C:\ApexTweaker\v3.1.0-portable`.
