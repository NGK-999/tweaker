...
[Files]
Source: "..\release-v2\ApexTweaker.exe"; DestDir: "{app}"; Flags: ignoreversion
...
[Run]
Filename: "{app}\ApexTweaker.exe"; Description: "Executar ApexTweaker"; Flags: nowait postinstall skipifsilent
