...
public partial class MainWindow : Window
{
    ...
    private void EnsureCommandPaletteItems()
    {
        ...
        [
            new CommandPaletteItem("Dashboard", "Página inicial: status e Auto-Optimize", () => ShowPageAsync(DashboardPageKey, DashboardButton)),
            new CommandPaletteItem("Desempenho", "VBS/HAGS/GameDVR e ações de estabilidade", () => ShowPageAsync(PerformancePageKey, PerformanceButton)),
            ...
            new CommandPaletteItem("Catálogo", "Analyze, riscos e checklist BIOS", () => ShowPageAsync(CatalogPageKey, CatalogButton)),
            ...
            new CommandPaletteItem("UI noise", "Tweak mercado: menos ruído de UI", () => HandleModuleRequestedAsync("UI noise")),
            new CommandPaletteItem("Memory", "Tweak mercado: memória", () => HandleModuleRequestedAsync("Memory")),
            new CommandPaletteItem("Rede avançada", "Tweak mercado: rede avançada", () => HandleModuleRequestedAsync("Rede avancada")),
            new CommandPaletteItem("Debloat", "Tweak mercado: debloat condicional", () => HandleModuleRequestedAsync("Debloat")),
            new CommandPaletteItem("Timer resolution", "Tweak avançado: BCD timer (reinício)", () => HandleModuleRequestedAsync("Timer resolution")),
            ...
            new CommandPaletteItem("CTT Advanced", "WinUtil-inspired: pacote Advanced (confirmação)", () => HandleModuleRequestedAsync("CTT Advanced")),
