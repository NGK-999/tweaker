...
internal sealed class MinecraftModConfigContractCatalog
{
    ...
    [
        ...
        new(
            ...
            "Contrato conhecido para 1.6.11, mas a v3.1 preserva defaults e exige benchmark isolado antes de qualquer KEEP.",
        ...
        new(
            ...
            "Defaults sao preservados; bugs em Pokemon exigem validacao visual e whitelist manual.",
